...
const navMenus = $$('.item-left');

navMenus.forEach((item) => {
    item.addEventListener('mouseover', function(e){
        const $ = document.querySelector.bind(document);
        $('.item-left.active-item-left').classList.remove('active-item-left')
        this.classList.add('active-item-left')
    })
})  
$('.item-left-1').onmouseover = function(){
    $('.navbar__menu-list-right').innerHTML =`
...
$('.item-left-2').onmouseover = function(){
    $('.navbar__menu-list-right').innerHTML = `
    <h2 class="title-right">
    <i
      style="
...
$('.item-left-3').onmouseover = function(){
    $('.navbar__menu-list-right').innerHTML = `
    <h2 class="title-right">
    <i
      style="
...
$('.item-left-4').onmouseover = function(){
    $('.navbar__menu-list-right').innerHTML = `
    <h2 class="title-right">
    <i
      style="
...
$('.item-left-5').onmouseover = function(){
    $('.navbar__menu-list-right').innerHTML = `
    <h2 class="title-right">
    <i
      style="
...
$('.item-left-6').onmouseover = function(){
    $('.navbar__menu-list-right').innerHTML = `
    <h2 class="title-right">
    <i
      style="
...
$('.item-left-7').onmouseover = function(){
    $('.navbar__menu-list-right').innerHTML = `
    <h2 class="title-right">
    <i
      style="
...
$('.item-left-8').onmouseover = function(){
    $('.navbar__menu-list-right').innerHTML = `
    <h2 class="title-right">
    <i
      style="
...
$('.item-left-9').onmouseover = function(){
    $('.navbar__menu-list-right').innerHTML = `
    <h2 class="title-right">
    <i
      style="
...
$('language').onclick = () => {
    $('language-choice').style.display = 'block';
}